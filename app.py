...
def analyze():
    ...
    dob_info = {"name": name, "date": date, "month": month, "year": year}
    with open('dob.json', 'w') as f:
        json.dump(dob_info, f)
    ...
    # Name analysis
    values, total_sum, final_result = calculate_name_value(name)
    ...
    return render_template('result.html', 
                           ...
                           name_total_sum=total_sum,
                           name_final_result=final_result,
